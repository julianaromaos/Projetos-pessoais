...
<head>
    ...
    <title>Novo Treinamento | JS Empreendimentos</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i> Cadastrar Novo Treinamento</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-8">
                                        <label for="nomeTreinamento" class="form-label required-field">Nome do Treinamento</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="tipoTreinamento" required>
                                            ...
                                            <option value="nr33">NR-33 - Espaços Confinados</option>
                                            <option value="nr6">NR-6 - EPIs</option>
                                            <option value="primeiros_socorros">Primeiros Socorros</option>
                                            <option value="cipa">CIPA - NR-5</option>
                            ...
                            <div class="form-section">
                                <h6 class="form-section-title"><i class="fas fa-map-marker-alt me-2"></i>Local e Instrutor</h6>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="localTreinamento" required>
                                            <option value="">Selecione...</option>
                                            <option value="sala1">Sala de Treinamento 1</option>
                                            <option value="sala2">Sala de Treinamento 2</option>
                                            <option value="auditorio">Auditório Principal</option>
                                            <option value="externo">Local Externo</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="instrutor" class="form-label required-field">Instrutor</label>
                                        <select class="form-select" id="instrutor" required>
                                            <option value="">Selecione...</option>
                                            <option value="1">Maria Oliveira</option>
                                            <option value="2">Carlos Souza</option>
                                            <option value="3">Ana Paula</option>
                                            <option value="4">João Silva</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="vagas" class="form-label required-field">Vagas Disponíveis</label>
                                        <input type="number" class="form-control" id="vagas" min="1" value="20" required>
                                    </div>
                                    <div class="col-md-6">
